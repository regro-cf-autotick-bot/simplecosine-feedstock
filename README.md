...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/simplecosine-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14398&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/simplecosine-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `simplecosine` can be installed with:

```
conda install simplecosine
```

It is possible to list all of the versions of `simplecosine` available on your platform with:
